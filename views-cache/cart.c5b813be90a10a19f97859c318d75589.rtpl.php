                                    ...
                                    <tr class="cart_item">
                                        ...
                                        <td class="product-quantity">
                                            <div class="quantity buttons_added">
                                                ...
                                                <input type="number" size="4" class="input-text qty text" title="Qtd" value="<?php echo htmlspecialchars( $value1["nrqtd"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" min="0" step="1">
                                ...
                                <div class="cart_totals ">
                                    ...
                                    <table cellspacing="0">
                                        <tbody>
                                            ...
                                            <tr class="shipping">
                                                <th>Frete</th>
                                                <td>R$ <?php if( $cart["vlfreight"] !='' ){ ?><?php echo formatPrice($cart["vlfreight"]); ?><?php } ?><?php if( $cart["nrdays"] > 0 ){ ?> <small>prazo de <?php echo htmlspecialchars( $cart["nrdays"], ENT_COMPAT, 'UTF-8', FALSE ); ?> dia(s)</small><?php } ?></td>
                                            </tr>
